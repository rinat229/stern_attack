 ...
 */
std::optional<boost::dynamic_bitset<>> InformationSetDecodingStep(BinaryMatrix& checkMatrix, boost::dynamic_bitset<> syndrome, const unsigned p, const unsigned omega, const unsigned = 0) {
